<div class="py-6">
    ...
    <?php while( have_rows('card_femmine') ): the_row(); 

        $id = rand();
        $img = get_sub_field('immagine_card_F');
            ...
            <div class="py-5">
                <div class="card">
                    ...
                    <div class="collapse" id="<?php echo "collapseExample2-" . $id; ?>" data-parent="#<?php echo "accordionExample-" . $id; ?>">
                        ...
                        <?php if( have_rows('galleria_card_F') ): ?>
                        <div class="row py-2">
                        <?php while( have_rows('galleria_card_F') ): the_row(); 

                            $imgGallery = get_sub_field('immagine_galleria_F');
